...
(function () {
  var addslashes, addslashes_single_quotes, FileMakerCodeGeneratorNew;
  ...
  FileMakerCodeGeneratorNew = function () {
    var self;
    self = this;
  ...
  FileMakerCodeGeneratorNew.identifier = "com.proofgroup.PawExtensions.FileMakerCodeGeneratorNew";

  FileMakerCodeGeneratorNew.title = "FileMakerNew";

  FileMakerCodeGeneratorNew.fileExtension = "sh";

  FileMakerCodeGeneratorNew.languageHighlighter = "bash";

  registerCodeGenerator(FileMakerCodeGeneratorNew);
...
for (var i = 0; i < components.length; i++) {
  ...
  if (typeof component === 'string') {
    ...
    // environment variable
      ...
      var envVariable = ctx.getEnvironmentVariableById(component.environmentVariable);
      if (requestVariable) {
        urlPattern += '[' + envVariable.name + ']';
      }
      else {
